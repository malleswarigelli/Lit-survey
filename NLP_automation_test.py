...
df= pd.read_excel ('/Users/malli.gelli/Desktop/Git_Repo/AutoLitSurvey/Malli_test/Input1_.xlsx')
...
# function access .json file/Azure blob from Azure container using keywords
    ...
    with open('azure://literaturemining/'+keywords+'.json', transport_params=transport_params) as fin:
        #print('file name is:',fin)
        new_data = pd.read_json(fin)
        new_data.to_json(keywords+'.json', orient='records')
        #print(new_data.head())
...
access_json('Fixed_sesqui_pathway')
